odoo.define('aspl_giftcard_package_ee.giftCardCreatePopupConform', function(require) {
    'use strict';
    ...
    class giftCardCreatePopupConform extends AbstractAwaitablePopup {
        ...
        getConfirmPayload() {
            return {
                ...
                select_customer: Number(this.state.SelectCustomer),
                text_expire_date: this.state.ExpireDate,
                text_amount: this.state.Amount,
                SelectCardType: this.state.SelectCardType,
